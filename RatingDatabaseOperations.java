...
public class RatingDatabaseOperations extends SQLiteOpenHelper {
    ...
    public String CREATE_QUERY="CREATE TABLE " + RatingTableData.RatingTableInfo.TABLE_NAME + " (" +
            RatingTableData.RatingTableInfo.RES_NAME+ " TEXT," + RatingTableData.RatingTableInfo.USER_NAME + " TEXT," + RatingTableData.RatingTableInfo.USER_EMAIL
    ...
    public void putInformation(RatingDatabaseOperations rdop, String rName, String uName, String uEmail, String uRating, String uReview){
    ...
    public Cursor getInformation(RatingDatabaseOperations rdop){
        ...
        String[] coloumns = {RatingTableData.RatingTableInfo.RES_NAME,RatingTableData.RatingTableInfo.USER_NAME,RatingTableData.RatingTableInfo.USER_EMAIL,
